...
ctypes.windll.kernel32.SetConsoleTitleW(f"nismos funny report tool :3 ")
...
{b+Fore.CYAN} {Fore.RESET}Options

{b+Fore.CYAN} {1} {Fore.RESET}illegal Conent 
{b+Fore.CYAN} {2} {Fore.RESET}Harrassment 
{b+Fore.CYAN} {3} {Fore.RESET}Spam or Phishing Links 
{b+Fore.CYAN} {4} {Fore.RESET}Self harm 
{b+Fore.CYAN} {5} {Fore.RESET}NSFW Content 
""")
...
def Main():
  ...
  while True:
    ...
    if r.status_code == 201:
      ...
      ctypes.windll.kernel32.SetConsoleTitleW(f"nismos funny report tool :3 | reports sent: %s" % sent)
      sent += 1
